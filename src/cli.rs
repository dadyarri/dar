...
// ENTR[DATA]
// ...
// INDX[OFFSET][COMPRESSION_ALGO][TIMESTAMP][UID][GID][PERM][UNCOMPRESSED_SIZE][COMPRESSED_SIZE][BLAKE3_CHECKSUM][PATH_LENGTH][PATH][EXTRA_FIELDS_LENGTH][EXTRA_FIELDS]
// ENDR[INDX_OFFSET][INDX_LENGTH][BLAKE3_CHECKSUM_OF_ENTIRE_ARCHIVE]
